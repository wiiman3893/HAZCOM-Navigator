// CODEX HANDOFF (2026-09-20): This implements explicit immutable publish-revision flow from Windows SQLite to Firebase.
// Do NOT replace it with raw SQLite upload or continuous bidirectional Firestore sync. Storage deployment is pending Blaze/default bucket only.
