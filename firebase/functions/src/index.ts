// CODEX HANDOFF (2026-09-20): These callable contracts are the completed backend foundation, not placeholders.
// Preserve Account -> entitlement -> Company coverage -> membership/role checks. All privileged client mutations intentionally route here.
// Cloud Functions were not deployed only because Blaze/Artifact Registry was blocked. See firebase/CODEX_HANDOFF.md before changing architecture.
