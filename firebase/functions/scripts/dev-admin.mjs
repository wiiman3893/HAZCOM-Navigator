// CODEX HANDOFF (2026-09-20): Development-only IAM/ADC utility. Never expose this through the desktop/mobile client or deploy it as a Function.
// It exists so a real Google-authenticated development UID can receive a test entitlement without implementing billing first.
