export const INITIAL_SCHEMA_SQL = `-- Constellation Data Management schema plan for Hazcom Navigator
...
export const DERIVED_VIEWS_SQL = `-- Derived projections required by the Constellation specification.
