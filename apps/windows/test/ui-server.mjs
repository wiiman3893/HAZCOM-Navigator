...
const sql=nodeSqlite(path.join(folder,'ui.db'),REPLICA_SCHEMA_SQL+await readFile(path.join(repo,'database/migrations/003_authoring.sql'),'utf8')),files=await nodeFiles(path.join(folder,'attachments'));
